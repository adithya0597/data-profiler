...
class ProfilerConfig(BaseModel):
    ...
    output_format: str = Field(default="json", pattern="^(json|parquet|yaml|csv|html)$")
    ...
    validate_constraints: bool = Field(default=False, description="Run validation queries against discovered constraints")
